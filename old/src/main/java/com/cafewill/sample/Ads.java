...
public class Ads
{
    ...
    public interface Listener { public void onLoaded(String type); public void onFailed(); }
    ...
    public View getBanner (final Context context, final String type, final String adid, final String unit)
    {
        ...
        try
        {
            if (GOOGLE.equals (type)) banner = getGoogleBanner (context, type, adid, unit);
            if (FACEBOOK.equals (type)) banner = getFacebookBanner (context, type, adid, unit);
        } catch (Exception e) { e.printStackTrace (); }

        return (banner);
    }

    private com.google.android.gms.ads.AdView getGoogleBanner (final Context context, final String type, final String adid, final String unit)
    {
        ...
        try
        {
            ...
            banner.setAdListener (new com.google.android.gms.ads.AdListener ()
            {
                ...
                public void onAdLoaded ()
                {
                    ...
                    if (null != listener) listener.onLoaded (type);
                }
                @Override
    ...
    private com.facebook.ads.AdView getFacebookBanner (final Context context, final String type, final String adid, final String unit)
    {
    ...
    public static void showInterstitial (final String type, Object interstitial)
    {
        if (null != interstitial)
        {
            if (GOOGLE.equals (type)) ((com.google.android.gms.ads.InterstitialAd) interstitial).show ();
            if (FACEBOOK.equals (type)) ((com.facebook.ads.InterstitialAd) interstitial).show ();
        }
    }
    ...
    public Object getInterstitial (final Context context, final String type, final String adid, final String unit)
    {
        ...
        try
        {
            if (GOOGLE.equals (type)) interstitial = getGoogleInterstitial (context, type, adid, unit);
            if (FACEBOOK.equals (type)) interstitial = getFacebookInterstitial (context, type, adid, unit);
        } catch (Exception e) { e.printStackTrace (); }

        return (interstitial);
    }

    private com.google.android.gms.ads.InterstitialAd getGoogleInterstitial (final Context context, final String type, final String adid, final String unit)
    {
    ...
    private com.facebook.ads.InterstitialAd getFacebookInterstitial (final Context context, final String type, final String adid, final String unit)
    {
